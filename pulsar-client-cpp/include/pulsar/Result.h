...
enum Result {
  ...
  ResultAlreadyClosed,  /// Producer/Consumer is already closed and not accepting any
                        /// operation
  ...
  ResultInvalidUrl,  /// Client Initialized with Invalid Broker Url (VIP Url passed to
                     /// Client Constructor)
  ResultServiceUnitNotReady,  /// Service Unit unloaded between client did lookup and
  ...
  ResultUnsupportedVersionError  /// Error when an older client/version doesn't support a
                                 /// required feature
};
