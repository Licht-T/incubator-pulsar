...
class ClientConfiguration {
 public:
  ...
  /**
   * Number of concurrent lookup-requests allowed on each broker-connection to prevent
   * overload on broker.
   * <i>(default: 5000)</i> It should be configured with higher value only in case of it
   * requires to produce/subscribe on
  ...
  /*
   * Initialize stats interval in seconds. Stats are printed and reset after every
