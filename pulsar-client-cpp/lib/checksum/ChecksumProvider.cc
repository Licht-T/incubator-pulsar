...
/**
 *  computes crc32c checksum: uses sse4.2 hardware-instruction to compute crc32c if
 * machine supports else it computes using sw algo
 *  @param
 *  previousChecksum = in case of incremental-checksum-computation pass previous computed
 * else pass 0 in other case.
