 ...
 *
 * \brief This class is a container for holding individual messages being published until
 * they are batched and sent to broker.
 *
...
class BatchMessageContainer {
 public:
  ...
  friend inline std::ostream& operator<<(
      std::ostream& os, const BatchMessageContainer& batchMessageContainer);
 ...
 private:
  ...
  // This copy (to vector) is needed since OpSendMsg no long holds the individual message
  // and w/o a container
